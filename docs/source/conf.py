...
# PyQt6 is also mocked so ospgui.py can be imported for API documentation
...
nbsphinx_execute = "auto"  # Execute notebooks without stored output during docs build
